...
parser.add_argument("--lr", help="Initial value for learning rate.", default=1e-2, type=float, required=False)
parser.add_argument("--min_lr", help="Minimum learning rate cap.", default=1e-5, type=float, required=False)
parser.add_argument("--decay", help="Exponential decay rate.", default=0.99, type=float, required=False)
parser.add_argument("--decay_start", help="The epoch to start decaying the learning rate.", default=3000, type=int, required=False)
parser.add_argument("--decay_steps", help="Transition steps before next lr decay.", default=50, type=int, required=False)
...
parser.add_argument("--val_epochs", help='Frequency for running evaluation', type=int, default=200)
parser.add_argument("--val_batches", help='Number of batches to process per evaluation', type=int, default=10)
...
parser.add_argument("--drop_final_layer", 
                    help="Drops the final layer from the restored model. Enables using pretrained weights on a different number of classes", 
                    action="store_true")
