...
parser.add_argument("--decay_start", help="The epoch to start decaying the learning rate.", default=200, type=int, required=False)
...
parser.add_argument("--debugging", help="Runs in debuggin mode.", action="store_true")
